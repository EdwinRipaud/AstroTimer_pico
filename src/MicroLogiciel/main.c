...
// TODO: move this structure declaration into a timer.c
typedef struct { // TODO: standardize variable names
    int numberPicture;
    float exposureTime;
    float delayTime;
} TimerData_t;
...
// TODO: move this function into a timer.c
JsonStatus parse_timer_JSON(http_connection conn, TimerData_t* out) {
    char buffer[128];
    int count = 0;
